...
Page({
  ...
  /* 导航栏切换 */
  changeNav(e) {
    let navId = e.currentTarget.id; // 通过id向event传参的时候如果传的是number会自动转换成string
  ...
  handlePlay(event) {
    ...
    * */
    ...
    let videoItem = videoUpdateTime ? videoUpdateTime.find(item => item.vid === vid) : '';
    if (videoItem) {
